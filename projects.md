...
Human conceptual representations are rich in structural and statistical knowledge. Structured models can capture compositional and causal structure through grammars and programs, but they struggle with the most complex correlations found in raw data. In contrast, neural networks excel at processing raw stimuli and capturing complex statistics, but they struggle to capture compositional and causal knowledge. The human mind seems to transcend this dichotomy: learning compositional and causal structure from raw inputs, and capturing complex correlations.

<img class="fig" src="/images/projects/fig-gns.jpg" width="300">
We are developing neuro-symbolic generative models that incorporate key aspects of previous approaches. Our models can learn compositional and causal programs from raw data, while using neural sub-routines for powerful statistical modeling (see diagram). We are developing this framework to understand the dual structural and statistical natures of human concepts, and to learn neuro-symbolic representations for machine learning applications.
...
To better understand these distinctively human abilities, we have been studying human compositional learning of language-like instructions. Based on behavioral insights, we are developing novel meta-learning and neural-symbolic models that solve popular compositional learning benchmarks. Additional work focuses on learning compositional visual concepts and developing more challenging benchmarks for AI, e.g., few-shot learning of concepts like "cautiously" (see image of "walking to the red circle cautiously," which requires looking both ways before moving).
...
Learning to play video games is a popular AI benchmark that is ideal for comparing human and machine learning. Although the best algorithms outscore people on many games, they require hundreds of hours of experience to learn a new game while people need just a few minutes. The experience gap is only widening: OpenAI recently trained their Dota 2 bot for 45,000 years worth of game experience. Our hypothesis is that key cognitive ingredients are missing from AI systems and holding them back, including representations of objects, agents, compositionality, and causality.

<img class="fig" src="/images/projects/fig-games-crop.jpg" width="280">
To evaluate this hypothesis, we are integrating cognitive ingredients into deep reinforcement learning (RL) algorithms and evaluating their performance. With simple object representations, models can achieve higher scores and better generalization in new test scenarios (see image of agent surrounded by enemies). Ongoing work is studying the importance of agents, compositionality, and causality.
